...
const config = {
  ...
  navigation: {
    items: [
      ...
      { label: "Background", link: "/background", external: false },
      {
        ...
        link: "https://scholar.google.com/citations?hl=en&user=sjaXtioAAAAJ",
        external: true,
        icon: "google-scholar",
      },
    ],
  ...
  background_points: {
    education: [
      {
        ...
        date: "AUG 2026 -",
        logoSrc: "/images/organizations/university-of-colorado.png",
      },
      {
        title: "M.S.",
        ...
        logoSrc: "/images/organizations/arizona-state-university.png",
      },
      {
        title: "B.S.",
        org: "Computer Science",
    ...
    experience: [
      {
        ...
        org: "Boulder AI and Systems Infrastructure Lab (BASIL)",
        location: "Boulder, CO",
        date: "MAY 2024 - Present",
        logoSrc: "/images/organizations/university-of-colorado.png",
        meta: (
          <>
            Co-advised by <MarkZhao />
          </>
        ),
        bullets: [
          "Researching efficient satellite inference for geospatial foundation models via computer systems engineering",
        ],
      },
      {
        title: "Research Assistant",
        ...
        meta: (
          <>
            Co-advised by <EstherRolf />
          </>
        ),
        bullets: [
          "Researching efficient satellite inference for geospatial foundation models through theoretical ML techniques",
        ],
      },
      {
        title: "Research Assistant",
        ...
        logoSrc: "/images/organizations/kerner-lab.png",
        meta: (
          <>
        ...
        bullets: [
          ...
          // "Creating efficient geo-foundational models with MoEs that are fault tolerable and optimized for edge compute",
        ],
      },
      {
        ...
        logoSrc: "/images/organizations/air-force-research-laboratory.png",
        bullets: [<i>DETAILS WITHHELD</i>],
      },
      {
        title: "Research Intern",
        org: "Air Force Research Laboratory",
      ...
      },
      {
        ...
        logoSrc: "/images/organizations/argos-vision.png",
        meta: (
          <>
      ...
      },
      {
        ...
        bullets: [
          "Researched generative text-to-music modeling by finetuning music and text models via a MAE architecture",
      ...
      },
      {
        ...
        logoSrc: "/images/organizations/pagasa.svg",
        meta: (
          <>
    ...
    publications: [
      {
        title:
          "Achieving Fault-Tolerant and Efficient Geospatial Image Modeling Onboard Satellites",
        date: "MAY 2026",
        authors: [{ name: "Benjamin Herrera", you: true }],
        note: <>Master's Thesis</>,
        links: [
          {
            label: "thesis",
            href: "https://www.proquest.com/docview/3371615453",
          },
          {
            label: "slides",
            href: "https://docs.google.com/presentation/d/1QbJIcgy2_9mq-e4-hKbv1dBCCMfpW_jZVkjkFm_Azsg/edit?usp=drive_link",
          },
        ],
      },
      {
        ...
        note: <>ICML 2026</>,
        links: [
          { label: "pre-print", href: "https://arxiv.org/pdf/2602.04870v1" },
          {
            label: "conference paper",
            href: "https://icml.cc/virtual/2026/poster/64570",
          },
          {
            label: "code",
    ...
    fellowships: [
      ...
      },
      {
        ...
        note: (
          <>
            <i>National Science Foundation</i> — <b>$159,000</b> across three
            years of funding
          </>
        ),
        date: "MAR 2025",
    ...
    leadership: [
      {
        title: "Main Lead & Sponsor",
        org: "The Ezra Company",
        location: "Tempe, AZ",
        date: "JAN 2026 - AUG 2026",
        logoSrc: "/images/organizations/ezra-company.png",
        bullets: [
         <>Sponsoring five Computer Science UG seniors for their capstone project in line with the <b>Ezra Company</b></>,
        ],
      },
      {
        ...
        location: "Phoenix, AZ",
        date: "JAN 2026 - AUG 2026",
        logoSrc: "/images/organizations/diocese-of-phoenix.png",
        bullets: [
      ...
      },
      {
        ...
        location: "Phoenix, AZ",
        date: "JAN 2020 - AUG 2026",
        logoSrc: "/images/organizations/saint-marys-basilica.png",
        bullets: [
      ...
      },
      {
        ...
        logoSrc:
          "/images/organizations/cyber-security-policy-development-club.png",
        bullets: [
      ...
      },
      {
        ...
        location: "Tempe, AZ",
        date: "AUG 2024 - DEC 2024",
        logoSrc: "/images/organizations/wingsuite.png",
        bullets: [
      ...
      },
      {
        ...
        location: "Tempe, AZ",
        date: "AUG 2024 - DEC 2024",
        logoSrc: "/images/organizations/asu-afrotc-detachment-025.png",
        bullets: [
