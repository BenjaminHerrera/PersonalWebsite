...
export function SeeMyWorkButton() {
  return (
    <motion.a
      href="#work" // Change to your actual link
      whileHover={{ scale: 1.05 }}
      whileTap={{ scale: 0.97 }}
      className="w-fit group relative inline-flex items-center justify-center overflow-hidden rounded-full border-2 border-transparent px-10 py-4 text-lg font-semibold text-white transition-all duration-500 ease-out"
    >
...
export default function ResearchWork() {
  return (
    <div className="relative h-screen w-full overflow-hidden bg-[#9abbff] text-center">
      {/* Front Content */}
